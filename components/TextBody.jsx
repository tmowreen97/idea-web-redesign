  ...
  return (
    <div >
      <div className="py-5">
        ...
        <h2 className="xl:text-5xl text-2xl pt-2 text-red_accent_2">{post.date}</h2>
      </div>
        ...
        {post.extended_text ? 
          <div >
            ...
            <div className="text-center p-2 text-primary_text" >
              <button onClick={()=> setShowExtended(!showExtended)} className={showExtended ? "bg-secondary_text text-dark_text hover:bg-button_bg_2/80 hover:text-secondary_text p-3 px-4 rounded-xl text-lg " : "bg-secondary_text text-dark_text hover:bg-button_bg_2/80 hover:text-secondary_text p-3 px-4 rounded-xl text-lg my-10"}>
