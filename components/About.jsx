    ...
    <div id='about' className='w-screen md:max-h-[980px] bg-[#DAD3DF] '>
      <div className='relative flex items-center align-middle justify-center p-4 ml-[15%]'>
        <div className="about__parent ">
          ...
          <div className="about__img bg-[#a593b1]/50 items-center justify-center align-middle text-center p-5 ml-20 w-[175%] animate-wiggle delay-200 rounded-xl m-5 hover:animate-none">
            
            <div className='relative'>
              {reveal ? <div id='cover' className=' z-10 absolute left-[-8px] bg-[#322d44]/80 px-[146px] py-[143px] rounded-xl animate-none ml-2'>
