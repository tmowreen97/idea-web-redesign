        ...
        <div className="about__parent lg:grid mt-[5%] lg:mx-[15%]">
          ...
          <div className="about__child1 p-4 m-4 lg:m-0 lg:text-lg items-center justify-center bg-secondary rounded-xl lg:w-[645px] ">
            <div className='lg:m-14 m-3'>
              <h2 className="tracking-wider text-red_accent">Our Story</h2>
            </div>
            <div className='lg:m-14 m-3'>
              <div>
                <p className='my-[4%]'>
          ...
          <div className="about__child2 p-4 m-4 lg:m-0 lg:text-lg items-center justify-center bg-secondary rounded-xl lg:w-[485px]  ">
            <div className='lg:my-14 m-3 lg:mx-8'>
              <h2 className="tracking-wider text-red_accent ">Our Mission</h2>
            </div>
            ...
            <div className="relative items-center justify-center" onMouseOver={()=> setShow(true)} onMouseLeave={()=> setShow(false)}>
                ...
                <Link href={'/team'}>
                  <div className="relative ">
                    {isBreakPoint ? <Image src={'/assets/our-team-pic.jpg'} width={200} height={100} alt={'team'} className='rounded-xl'/> : <Image src={'/assets/team.jpeg'} width={500} height={300} alt={'team'} className='rounded-xl'/> }
                    <div className={show ? "absolute bg-cover bottom-0 left-0 right-0 top-0 bg-tertiary/80 rounded-xl text-secondary_text  " : "hidden"}>
