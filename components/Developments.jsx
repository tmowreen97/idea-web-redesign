        ...
        <div className="flex items-center justify-center px-[10%] 2xl:px-[14%] py-[5%]">
          <div>
            ...
            <div className="lg:flex justify-center gap-10">
              ...
              <div className="bg-secondary rounded-xl lg:w-[500px] m-2 relative">
      ...
      <div className="">
        <div className="w-full h-full bg-none lg:fixed top-0 bottom-0 right-0 left-0 z-10">
          <div className="lg:z-20 flex h-full w-full items-center justify-center bg-tertiary/90">
            <div className="justify-center items-center bg-accent_3 text-left p-20 rounded-2xl z-9 lg:z-20 m-20 h-full md:h-auto max-w-[2500px]  md:top-[10%] md:bottom-[10%] bottom-[0]">
